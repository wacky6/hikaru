...
test('create right budget', t => {
    const { createBudgetForStream, BudgetForRealtime, BudgetForFile } = require('../stream-budget')
...
test('Nop Budget', t => {
    const { BudgetForFile } = require('../stream-budget')
...
test('Realtime Budget', t => {
    const { BudgetForRealtime } = require('../stream-budget')
